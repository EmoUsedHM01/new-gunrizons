...
public class ItemWeapon extends Item implements ItemInstanceFactory<ItemWeaponInstance, WeaponState>, AttachmentContainer, Reloadable, Updatable {
   ...
   public String getCrosshair(ItemWeaponInstance weaponInstance) {
      if (weaponInstance.isAimed()) {
         ...
         return weaponInstance.getPlayer().func_70051_ag() ? this.crosshairRunning : this.crosshair;
      }
   }
   ...
   public void changeFireMode(ItemWeaponInstance instance) {
      ...
      String message;
      if (result == 1) {
         message = StatCollector.func_74837_a("gui.firearmMode.semi", new Object[0]);
      } else if (result == Integer.MAX_VALUE) {
         message = StatCollector.func_74837_a("gui.firearmMode.auto", new Object[0]);
      } else {
         message = StatCollector.func_74837_a("gui.firearmMode.burst", new Object[0]);
      }

      StatusMessageManager.INSTANCE.addMessage(StatCollector.func_74837_a("gui.firearmMode", new Object[]{message}), 1000L);
      if (Sounds.FIRE_MODE_SWITCH != null) {
         instance.getPlayer().func_85030_a(Sounds.FIRE_MODE_SWITCH, 1.0F, 1.0F);
      }

      NewGunrizonsMod.CHANNEL.sendToServer(new WeaponActionMessage((byte)4, ((EntityPlayer)instance.getPlayer()).field_71071_by.field_70461_c));
   }
   ...
   public void spawnBullet(EntityLivingBase player) {
      ...
      player.field_70170_p.func_72838_d(bullet);
   }

   public void spawnShell(ItemWeaponInstance weaponInstance, EntityLivingBase player) {
      EntityShellCasing shell = new EntityShellCasing(weaponInstance, player.field_70170_p, player, 0.1F, 0.05F, 20.0F);
      shell.setPositionAndDirection();
      player.field_70170_p.func_72838_d(shell);
   }
   ...
   public void incrementZoom(ItemWeaponInstance instance) {
      ...
      if (scopeItem instanceof ItemScope && ((ItemScope)scopeItem).isOptical()) {
         ...
         StatusMessageManager.INSTANCE.addMessage(StatCollector.func_74837_a("gui.currentZoom", new Object[]{Math.round(ratio * 100.0F)}), 800L);
         if (Sounds.ZOOM != null) {
            instance.getPlayer().func_85030_a(Sounds.ZOOM, 1.0F, 1.0F);
         }

         NewGunrizonsMod.CHANNEL.sendToServer(new WeaponActionMessage((byte)6, ((EntityPlayer)instance.getPlayer()).field_71071_by.field_70461_c));
      }
   }
   ...
   public void decrementZoom(ItemWeaponInstance instance) {
      ...
      if (scopeItem instanceof ItemScope && ((ItemScope)scopeItem).isOptical()) {
         ...
         NewGunrizonsMod.CHANNEL.sendToServer(new WeaponActionMessage((byte)7, ((EntityPlayer)instance.getPlayer()).field_71071_by.field_70461_c));
      }
   }
   ...
   public static class Builder {
      ...
      public ItemWeapon build() {
         if (this.name == null) {
            ...
            weapon.func_77637_a(this.creativeTab);
            weapon.func_77655_b(this.name);
            if (this.ammo != null) {
