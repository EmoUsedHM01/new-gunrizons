   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Semi-automatic Rifle", "Damage: 15", "Cartridge:", ".30-06 Springfield Bullet", "Fire Rate: Semi")
         )
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/m1garand"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.M1Garandaction.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.44F)
               )
