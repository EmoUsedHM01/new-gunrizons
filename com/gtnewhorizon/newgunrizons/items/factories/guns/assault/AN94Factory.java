      ...
      return new ItemWeapon.Builder()
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/an94"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.AN94action.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 1.5F)
               )
