   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: Semi-automatic carbine", "Damage: 7", "Caliber: .30 Carbine", "Magazines:", "15rnd .30 Carbine Magazine", "Fire Rate: Semi"
            )
         )
         .withCompatibleAttachment(AuxiliaryAttachments.M1CarbineAction, true, model -> GL11.glTranslatef(0.0F, 0.03F, 0.0F))
         .withCompatibleAttachment(AuxiliaryAttachments.M1CarbineRearSight, true, model -> {
            GL11.glTranslatef(-0.1385F, -1.11F, -0.8F);
            GL11.glScaled(0.11, 0.13, 0.13);
         })
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/m1carbine"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.M1CarbineAction.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.7F)
               )
