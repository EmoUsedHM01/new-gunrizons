   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: Battle Rifle", "Damage: 8", "Caliber: 7.62x51mm NATO", "Magazines:", "10rnd 7.62x51mm NATO Magazine", "Fire Rate: Semi"
            )
         )
         .withCompatibleAttachment(Magazines.HK417Mag, model -> GL11.glScaled(1.0, 1.0, 1.0))
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/hk417"))
