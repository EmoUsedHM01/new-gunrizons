   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Submachine gun", "Damage: 6.5", "Caliber: .45 ACP", "Magazines:", "31rnd .45 ACP Magazine", "Fire Rate: Auto")
         )
         .withCompatibleAttachment(Magazines.M3A1Mag, model -> GL11.glScaled(1.0, 1.0, 1.0))
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/m3a1greasegun"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.M3A1action.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 1.0F)
               )
               ...
               .withFirstPersonCustomPositioningUnloading(
                  Magazines.M3A1Mag, new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {
