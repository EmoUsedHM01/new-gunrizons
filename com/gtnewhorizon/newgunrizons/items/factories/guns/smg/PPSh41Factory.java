   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: Submachine gun", "Damage: 7.1", "Caliber: 7.52x25mm Tokarev", "Magazines:", "71rnd 7.62x25mm Tokarev Drum Magazine", "Fire Rate: Auto"
            )
         )
         ...
         .withCompatibleAttachment(AuxiliaryAttachments.PPSHRearSight, true, model -> {
            if (JsonModel.is(model, "sight/ppshrearsight")) {
               GL11.glTranslatef(-0.1645F, -0.715F, -0.12F);
               GL11.glScaled(0.2, 0.21, 0.2);
            }
         })
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/ppsh41"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.PPSH41action.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F)
               )
