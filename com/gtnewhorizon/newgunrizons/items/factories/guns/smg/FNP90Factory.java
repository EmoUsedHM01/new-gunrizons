   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: Personal defense weapon", "Damage: 6.5", "Caliber: 5.7x28mm", "Magazines:", "50rnd 5.7x28mm Magazine", "Fire Rate: Auto"
            )
         )
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/fnp90"))
               ...
               .withFirstPersonCustomPositioningReloading(
                  Magazines.FNP90Mag, new Transition(renderContext -> GL11.glTranslatef(1.0F, 1.0F, 0.5F), 250L, 1000L), new Transition(renderContext -> {
