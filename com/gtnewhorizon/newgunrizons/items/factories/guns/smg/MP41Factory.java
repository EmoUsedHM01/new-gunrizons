   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Submachine gun", "Damage: 6", "Caliber: 9mm", "Magazines:", "32rnd 9mm Magazine", "Fire Rate: Auto")
         )
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/mp41"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.MP40action.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 1.0F)
               )
