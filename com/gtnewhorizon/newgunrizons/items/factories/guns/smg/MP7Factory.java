   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: Personal defense weapon", "Damage: 6.6", "Caliber: 4.6x30mm", "Magazines:", "20rnd 4.6x30mm Magazine", "Fire Rate: Auto"
            )
         )
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/mp7"))
               ...
               .withFirstPersonCustomPositioningUnloading(
                  Magazines.HKMP7Mag, new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {
               ...
               .withFirstPersonCustomPositioningReloading(Magazines.HKMP7Mag, new Transition(renderContext -> {
                  ...
                  GL11.glRotatef(-20.0F, 1.0F, 0.0F, 0.0F);
               }, 250L, 1000L), new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {}, 250L, 1000L))
