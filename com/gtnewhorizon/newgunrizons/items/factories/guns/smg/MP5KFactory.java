   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Submachine gun", "Damage: 5", "Caliber: 9mm", "Magazines:", "25rnd 9mm Magazine", "Fire Rate: Auto")
         )
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/mp5k"))
               ...
               .withFirstPersonCustomPositioningUnloading(
                  Magazines.MP5KMag, new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {
