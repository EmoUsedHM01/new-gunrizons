   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: Submachine gun", "Damage: 7.6", "Caliber: 8x22mm Nambu", "Magazines:", "30rnd 8x22mm Nambu Magazine", "Fire Rate: Auto"
            )
         )
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/type100"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.Type100action.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 1.3F)
               )
