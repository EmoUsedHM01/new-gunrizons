   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Service Revolver", "Damage: 7", "Cartridge: .455 Webley Mk II Bullet", "Fire Rate: Double Action Revolver")
         )
         .withCompatibleAttachment(AuxiliaryAttachments.WebleyCylinder, true, model -> GL11.glScalef(1.0F, 1.0F, 1.0F))
         .withCompatibleAttachment(AuxiliaryAttachments.WebleyBullets, true, model -> GL11.glScalef(1.0F, 1.0F, 1.0F))
         .withCompatibleBullet(Bullets.Bullet455, model -> {})
         .withTextureName("Webley")
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/webley"))
               ...
               .withFirstPersonCustomPositioningLoadIteration(AuxiliaryAttachments.WebleyCylinder.getRenderablePart(), new Transition(renderContext -> {
                  GL11.glTranslatef(0.0F, -2.6F, -0.45F);
                  GL11.glRotatef(65.0F, 1.0F, 0.0F, 0.0F);
               ...
               .withFirstPersonCustomPositioningLoadIteration(AuxiliaryAttachments.WebleyBullets.getRenderablePart(), new Transition(renderContext -> {
                  GL11.glTranslatef(0.0F, -15.0F, -0.45F);
                  GL11.glRotatef(65.0F, 1.0F, 0.0F, 0.0F);
               }, 250L, 50L), new Transition(renderContext -> {
                  GL11.glTranslatef(0.0F, -15.0F, -0.45F);
