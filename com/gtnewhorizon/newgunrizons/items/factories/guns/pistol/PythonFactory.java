...
public class PythonFactory {
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(stack -> Arrays.asList("Type: Revolver", "Damage: 6", "Magazines: 6rnd .357 Clip", "Fire Rate: Semi"))
         .withCompatibleAttachment(AuxiliaryAttachments.PythonCase, true, model -> {})
         .withCompatibleAttachment(Magazines.PythonClip, model -> GL11.glScaled(0.0, 0.0, 0.0))
         .withCompatibleBullet(Bullets.Bullet357, model -> {})
         .withTextureName("Python")
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/python"))
               ...
               .withFirstPersonCustomPositioningUnloading(
                  Magazines.PythonClip, new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {}, 250L, 1000L)
               )
               .withFirstPersonCustomPositioningReloading(
                  Magazines.PythonClip,
                  new Transition(renderContext -> GL11.glScaled(0.0, 0.0, 0.0), 250L, 1000L),
                  new Transition(renderContext -> GL11.glScaled(0.0, 0.0, 0.0), 250L, 1000L),
                  new Transition(renderContext -> GL11.glScaled(0.0, 0.0, 0.0), 250L, 1000L),
                  new Transition(renderContext -> GL11.glScaled(0.0, 0.0, 0.0), 250L, 1000L),
                  new Transition(renderContext -> GL11.glScaled(0.0, 0.0, 0.0), 250L, 1000L)
