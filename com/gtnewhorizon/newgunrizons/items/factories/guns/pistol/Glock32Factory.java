...
public class Glock32Factory {
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(stack -> Arrays.asList("Type: Pistol", "Damage: 6", "Caliber: .357", "Magazines:", "14rnd .357 Magazine", "Fire Rate: Semi"))
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.Glock32Slide.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F)
               )
               ...
               .withFirstPersonCustomPositioningUnloading(Magazines.Glock32Mag, new Transition(renderContext -> {}, 250L, 1000L))
               ...
               .withFirstPersonCustomPositioningUnloading(
                  AuxiliaryAttachments.Glock32Slide.getRenderablePart(), new Transition(renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F), 250L, 1000L)
               )
               .withFirstPersonCustomPositioningReloading(
