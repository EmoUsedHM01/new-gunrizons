...
public class M9Factory {
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(stack -> Arrays.asList("Type: Pistol", "Damage: 5", "Caliber: 9mm", "Magazines:", "15rnd 9mm Magazine", "Fire Rate: Semi"))
         .withCompatibleAttachment(AuxiliaryAttachments.M9Top, true, model -> {
            if (JsonModel.is(model, "action/m9top")) {
               GL11.glScaled(1.0, 1.0, 1.0);
            } else if (JsonModel.is(model, "sight/m9rearsight")) {
               GL11.glTranslatef(-0.155F, -1.175F, -0.15F);
               GL11.glScaled(0.3, 0.3, 0.4);
            } else if (JsonModel.is(model, "sight/m9frontsight")) {
               GL11.glTranslatef(-0.15F, -1.175F, -1.85F);
               GL11.glScaled(0.25, 0.25, 0.3);
            }
         })
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/m9"))
               ...
               .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.M9Top.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F))
               .withFirstPersonPositioningCustomZoomingRecoiled(
                  AuxiliaryAttachments.M9Top.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F)
               )
               ...
               .withFirstPersonCustomPositioningUnloading(Magazines.M9BerettaMag, new Transition(renderContext -> {}, 250L, 1000L))
               ...
               .withFirstPersonCustomPositioningUnloading(
                  AuxiliaryAttachments.M9Top.getRenderablePart(), new Transition(renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F), 250L, 1000L)
               )
               .withFirstPersonCustomPositioningReloading(
