   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: Shotgun", "Damage per Pellet: 5", "Pellets per Shot: 10", "Cartridge: 12 Gauge Shotgun Shell", "Fire Rate: Pump-Action"
            )
         )
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/remington870"))
