   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Bolt-action rifle", "Damage: 30", "Cartridge:", "7.92x57mm Mauser Bullet", "Fire Rate: Bolt Action")
         )
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/kar98k"))
               ...
               .withFirstPersonCustomPositioningEjectSpentRound(
                  AuxiliaryAttachments.Kar98Kaction.getRenderablePart(), new Transition(renderContext -> {}, 250L, 50L), new Transition(renderContext -> {
               ...
               .withFirstPersonCustomPositioningLoadIteration(AuxiliaryAttachments.Kar98Kaction.getRenderablePart(), new Transition(renderContext -> {
                  GL11.glTranslatef(-1.38F, -1.05F, 1.1F);
                  GL11.glRotatef(90.0F, 0.0F, 0.0F, 1.0F);
               }, 250L, 50L), new Transition(renderContext -> {
                  GL11.glTranslatef(-1.38F, -1.05F, 1.1F);
               ...
               .withFirstPersonCustomPositioningAllLoadIterationsCompleted(
                  AuxiliaryAttachments.Kar98Kaction.getRenderablePart(), new Transition(renderContext -> {
                     GL11.glTranslatef(-1.38F, -1.05F, 1.1F);
                     GL11.glRotatef(90.0F, 0.0F, 0.0F, 1.0F);
                  }, 250L, 50L), new Transition(renderContext -> {
                     GL11.glTranslatef(-1.38F, -1.05F, 1.1F);
