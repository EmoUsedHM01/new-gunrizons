   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Sniper rifle", "Damage: 35", "Caliber: .50 BMG", "Magazines:", "7rnd .50 BMG Magazine", "Fire Rate: Bolt Action")
         )
         .withCompatibleAttachment(Magazines.HecateIIMag, model -> {
            GL11.glTranslatef(0.0F, -0.25F, 0.0F);
            GL11.glScaled(1.2, 0.7, 1.0);
         })
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/hecateii"))
               ...
               .withFirstPersonCustomPositioningUnloading(Magazines.HecateIIMag, new Transition(renderContext -> {
