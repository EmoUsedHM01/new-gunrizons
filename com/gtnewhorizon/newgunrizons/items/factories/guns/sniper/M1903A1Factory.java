...
public class M1903A1Factory {
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withCompatibleAttachment(Attachments.Unertl, true, true, (player, stack) -> GL11.glScaled(1.0, 1.0, 1.0), model -> {
            if (JsonModel.is(model, "sight/unertlreticle")) {
               GL11.glTranslatef(-0.157F, -1.599F, -0.569F);
               GL11.glScaled(0.012, 0.012, 0.012);
            } else if (JsonModel.is(model, "sight/m1903a1scope")) {
               GL11.glScaled(1.0, 1.0, 1.0);
            } else if (JsonModel.is(model, "sight/m1903a1scope2")) {
               GL11.glTranslatef(-0.2F, -1.56F, -1.5F);
               GL11.glScaled(0.37, 0.37, 0.6);
            }
         })
         .withTextureName("M1903A1")
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/m1903a1"))
