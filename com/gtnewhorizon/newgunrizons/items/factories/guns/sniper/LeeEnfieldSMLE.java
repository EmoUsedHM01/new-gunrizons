   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Bolt-action rifle", "Damage: 26", "Cartridge:", ".303 British Bullet", "Fire Rate: Bolt Action")
         )
         .withCompatibleAttachment(AuxiliaryAttachments.LeeEnfieldSMLEaction, true, model -> {
            if (JsonModel.is(model, "action/leeenfieldsmleaction")) {
            }
         })
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/leeenfieldsmlemk3"))
