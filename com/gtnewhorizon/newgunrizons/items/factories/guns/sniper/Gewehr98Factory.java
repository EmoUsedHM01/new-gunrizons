   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Bolt-action rifle", "Damage: 35", "Cartridge:", "7.92x57mm Mauser Bullet", "Fire Rate: Bolt Action")
         )
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/gewehr98"))
               ...
               .withFirstPersonCustomPositioningEjectSpentRound(
                  AuxiliaryAttachments.Gewehr98Action.getRenderablePart(), new Transition(renderContext -> {}, 250L, 50L), new Transition(renderContext -> {
