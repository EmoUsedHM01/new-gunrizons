   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: Semi-automatic Battle Rifle", "Damage: 13", "Caliber: 7.62x54mm", "Magazines:", "10rnd 7.62x54mm Magazine", "Fire Rate: Semi"
            )
         )
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/svt40"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.SVT40action.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.7F)
               )
               ...
               .withFirstPersonCustomPositioningUnloading(
                  Magazines.SVT40mag, new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {
