...
public class ItemScope extends ItemAttachment {
   ...
   public static final class Builder extends AttachmentBuilder {
      ...
      public ItemScope.Builder withViewfinderPositioning(BiConsumer<EntityLivingBase, ItemStack> viewfinderPositioning) {
      ...
      protected ItemAttachment createAttachment() {
         if (this.isOpticalZoom) {
            ...
            this.withPostRender(new ScopeRenderer(this.viewfinderPositioning));
         }
