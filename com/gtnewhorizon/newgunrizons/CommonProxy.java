...
public class CommonProxy {
   ...
   public void init(Object mod, FMLPreInitializationEvent event) {
      ...
      channel.registerMessage(new WeaponActionMessageHandler(WeaponFireAspect.INSTANCE), WeaponActionMessage.class, 15, Side.SERVER);
      channel.registerMessage(new GrenadeMessageHandler(GrenadeAttackAspect.INSTANCE), GrenadeMessage.class, 20, Side.SERVER);
      this.registerClientMessageHandlers(channel);
      EntityRegistry.registerModEntity(EntityBullet.class, "Ammo" + this.modEntityID, this.modEntityID++, mod, 64, 3, true);
      EntityRegistry.registerModEntity(EntityShellCasing.class, "ShellCasing" + this.modEntityID, this.modEntityID++, mod, 64, 500, true);
      EntityRegistry.registerModEntity(EntityGrenade.class, "Grenade" + this.modEntityID, this.modEntityID++, mod, 64, 10000, false);
   ...
   public void onWeaponFireEffects(EntityLivingBase player, float smokeOffsetX, float smokeOffsetY, boolean silencerOn) {
   }
