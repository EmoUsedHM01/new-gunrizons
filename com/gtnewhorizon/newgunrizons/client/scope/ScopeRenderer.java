      ...
      if (renderContext.getTransformType() == TransformType.FIRST_PERSON_RIGHT_HAND || renderContext.getTransformType() == TransformType.FIRST_PERSON_LEFT_HAND
         )
       {
         ...
         if (perspective != null) {
            ...
            tess.func_78374_a(3.0F * s, 3.0F * s, 0.0, 0.0, 0.0);
            tess.func_78374_a(0.0, 3.0F * s, 0.0, 1.0, 0.0);
            tess.func_78374_a(0.0, 0.0, 0.0, 1.0, 1.0);
            tess.func_78374_a(3.0F * s, 0.0, 0.0, 0.0, 1.0);
            tess.func_78381_a();
            GL11.glPopMatrix();
