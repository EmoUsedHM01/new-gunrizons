...
class DynamicShader extends Shader {
   ...
   public DynamicShader(
      IResourceManager resourceManager, String programName, Framebuffer framebufferInIn, Framebuffer framebufferOutIn, DynamicShaderGroup shaderGroup
   ) throws JsonException {
      super(resourceManager, programName, framebufferInIn, framebufferOutIn);
      this.shaderGroup = shaderGroup;
   }

   public void func_148042_a(float partialTicks) {
      this.shaderGroup.getUniforms().forEach((name, value) -> {
         ShaderUniform uniform = this.func_148043_c().func_147991_a(name);
         if (uniform != null) {
      ...
      super.func_148042_a(partialTicks);
   }
}
