...
public class AuxiliaryAttachments {
   ...
   public static void init() {
      AR15Iron = new AttachmentBuilder()
         ...
         .build();
      M16A1CarryHandle = new AttachmentBuilder()
      ...
      Extra = new AttachmentBuilder()
         ...
         .withTextureName("Dummy.png")
         .build();
      M3A1sight = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA6)
         ...
         .withTextureName("Dummy.png")
         .build();
      LeeEnfieldSMLESight = new AttachmentBuilder()
         ...
         .withTextureName("Dummy.png")
         .build();
      PPSHRearSight = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA7)
         .withModel(new JsonModel("sight/ppshrearsight"), "PPSH41.png")
         .withName("PPSHRearSight")
         .withTextureName("Dummy.png")
         .build();
      SpringfieldRearSight = new AttachmentBuilder()
      ...
      M1Garandaction = new AttachmentBuilder()
         ...
         .withTextureName("Dummy.png")
         .build();
      Tec9Action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA7)
         ...
         .withTextureName("Dummy.png")
         .build();
      M249Action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      M249Cover = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA3)
         ...
         .withTextureName("Dummy.png")
         .build();
      LeeEnfieldSMLEaction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA7)
         ...
         .withTextureName("Dummy.png")
         .build();
      LeeEnfieldClip = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA3)
         ...
         .withTextureName("Dummy.png")
         .build();
      LeeEnfieldClipBullets = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      M3A1action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA7)
         ...
         .withTextureName("Dummy.png")
         .build();
      SpringfieldAction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA7)
         ...
         .withTextureName("Dummy.png")
         .build();
      Kar98Kaction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA7)
         ...
         .withTextureName("Dummy.png")
         .build();
      Gewehr98Action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA7)
         ...
         .withTextureName("Dummy.png")
         .build();
      STG44Action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA7)
         ...
         .withTextureName("Dummy.png")
         .build();
      M1GarandMag1 = new AttachmentBuilder()
         ...
         .withTextureName("Dummy.png")
         .build();
      M1GarandMag2 = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      LugerAction1 = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      LugerAction2 = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA3)
         ...
         .withTextureName("Dummy.png")
         .build();
      WebleyCylinder = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      WebleyBullets = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA3)
      ...
      SKSmag2 = new AttachmentBuilder()
         ...
         .withTextureName("Dummy.png")
         .build();
      SKSaction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
      ...
      ExtraAR = new AttachmentBuilder()
         ...
         .withTextureName("Dummy.png")
         .build();
      DupletBarrels = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      SVT40action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      GlockTop = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      P99Slide = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      R700action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      M1A1action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      M1928action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      Saiga12action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      MP18action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      PPSH41action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      Type100action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      M1CarbineAction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      M1CarbineRearSight = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      Glock21Slide = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      Glock32Slide = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      MP40action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
      ...
      M9SDsuppressor = new AttachmentBuilder()
         ...
         .withTextureName("Dummy.png")
         .build();
      P2000Top = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      DeagleTop = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      Deagle44Top = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
      ...
      KSGPump = new AttachmentBuilder()
         ...
         .withTextureName("Dummy.png")
         .build();
      L115Bolt1 = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      SV98Action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      L115Bolt2 = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA3)
         ...
         .withTextureName("Dummy.png")
         .build();
      MosinBolt = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      MosinBolt2 = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA3)
         ...
         .withTextureName("Dummy.png")
         .build();
      RevolverCase = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA3)
         ...
         .withTextureName("Dummy.png")
         .build();
      PythonCase = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA3)
         ...
         .withTextureName("Dummy.png")
         .build();
      R870Pump = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      R870PumpTac = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      M1911Top = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      Taurus1911Slide = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      USP45Top = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      MakarovTop = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      Saiga12sights = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         .withModel(new JsonModel("sight/makarovrearsight"), "makarovrearsight.png")
         .withModel(new JsonModel("sight/makarovfrontsight"), "makarovfrontsight.png")
         ...
         .withTextureName("Dummy.png")
         .build();
      FNP90Sight = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      M14Rail = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         .withModel(new JsonModel("misc/m14rail"), "GunmetalTexture.png")
         .withName("M14Rail")
         .withTextureName("Dummy.png")
         .build();
      M14Action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withRenderablePart()
         .build();
      M14Action2 = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
      ...
      P226Top = new AttachmentBuilder()
         ...
         .withTextureName("Dummy.png")
         .build();
      MP5KGrip = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA3)
         ...
         .withTextureName("Dummy.png")
         .build();
      HecateIIBoltAction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      AR15Action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      M110action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      BushmasterACRAction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
         ...
         .withTextureName("Dummy.png")
         .build();
      RemingtonACRAction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA)
      ...
      AKpart2 = new AttachmentBuilder()
         ...
         .withTextureName("Dummy.png")
         .build();
      AKS74UIron = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA3)
      ...
      AUGRail = new AttachmentBuilder()
         ...
         .withTextureName("Dummy.png")
         .build();
      BushmasterACRRail = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA5)
         .withModel(new JsonModel("misc/akrail"), "AK12.png")
         .withModel(new JsonModel("misc/akrail2"), "AK12.png")
         .withModel(new JsonModel("misc/akrail3"), "AK12.png")
         ...
         .withTextureName("Dummy.png")
         .build();
      RemingtonACRRail = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA5)
      ...
      G36Rail = new AttachmentBuilder()
         ...
         .withTextureName("Dummy.png")
         .build();
      AKaction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA4)
         ...
         .withTextureName("Dummy.png")
         .build();
      AN94action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA4)
         ...
         .withTextureName("Dummy.png")
         .build();
      VSSVintorezAction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA4)
         ...
         .withTextureName("Dummy.png")
         .build();
      AK12action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA4)
         ...
         .withTextureName("Dummy.png")
         .build();
      M107action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA4)
         ...
         .withTextureName("Dummy.png")
         .build();
      ScarAction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA4)
         ...
         .withTextureName("Dummy.png")
         .build();
      G36Action = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA4)
         ...
         .withTextureName("Dummy.png")
         .build();
      FamasAction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA4)
         ...
         .withTextureName("Dummy.png")
         .build();
      AUGAction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA4)
         ...
         .withTextureName("Dummy.png")
         .build();
      FelinAction = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA4)
         ...
         .withTextureName("Dummy.png")
         .build();
      FamasBipod1 = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA2)
         ...
         .withTextureName("Dummy.png")
         .build();
      FamasBipod2 = new AttachmentBuilder()
         .withCategory(AttachmentCategory.EXTRA3)
         .withModel(new JsonModel("grip/famasbipod"), "AK12.png")
