   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Submachine gun", "Damage: 6", "Caliber: .45 ACP", "Magazines:", ".45 ACP 30rnd Box Magazine", "Fire Rate: Auto")
         )
         ...
         .withCompatibleAttachment(AuxiliaryAttachments.M1928rearsight, true, model -> {
            if (JsonModel.is(model, "sight/m1928rearsight")) {
               GL11.glTranslatef(-0.16F, -0.846F, 1.9F);
               GL11.glScaled(0.2, 0.175, 0.2);
            }
         })
         .withCompatibleAttachment(AuxiliaryAttachments.M1928action, true, model -> GL11.glTranslatef(0.0F, 0.0F, 1.3F))
         .withTextureName("M1A1Thompson")
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/m1928thompson"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.M1928action.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, -1.3F)
               )
