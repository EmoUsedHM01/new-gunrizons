   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Submachine Gun", "Damage: 5", "Caliber: 5.56x45mm NATO", "Magazines:", "30rnd 9mm Magazine", "Fire Rate: Auto")
         )
         .withCompatibleAttachment(Magazines.MPXmag, model -> GL11.glScaled(1.0, 1.0, 1.0))
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/mpx"))
