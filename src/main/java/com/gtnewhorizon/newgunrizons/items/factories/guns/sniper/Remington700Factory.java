...
public class Remington700Factory {
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(stack -> Arrays.asList("Type: Sniper rifle", "Damage: 27", "Cartridge: .308 Winchester", "Fire Rate: Bolt Action"))
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/remington700"))
               ...
               .withFirstPersonCustomPositioningEjectSpentRound(AuxiliaryAttachments.R700action.getRenderablePart(), new Transition(renderContext -> {
                  GL11.glTranslatef(-0.59F, -0.43F, -0.01F);
                  GL11.glRotatef(90.0F, 0.0F, 0.0F, 1.0F);
               }, 170L, 50L), new Transition(renderContext -> {
                  GL11.glTranslatef(-0.59F, -0.43F, 0.5F);
                  GL11.glRotatef(90.0F, 0.0F, 0.0F, 1.0F);
               ...
               .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.R700action.getRenderablePart(), new Transition(renderContext -> {
                  GL11.glTranslatef(-0.59F, -0.43F, -0.01F);
                  GL11.glRotatef(90.0F, 0.0F, 0.0F, 1.0F);
               }, 170L, 50L), new Transition(renderContext -> {
                  GL11.glTranslatef(-0.59F, -0.43F, 0.5F);
               ...
               .withFirstPersonCustomPositioningAllLoadIterationsCompleted(
                  AuxiliaryAttachments.R700action.getRenderablePart(), new Transition(renderContext -> {
                     GL11.glTranslatef(-0.59F, -0.43F, 0.5F);
                     GL11.glRotatef(90.0F, 0.0F, 0.0F, 1.0F);
                  }, 150L, 50L), new Transition(renderContext -> {
                     GL11.glTranslatef(-0.59F, -0.43F, -0.01F);
               ...
               .withFirstPersonCustomPositioningLoadIteration(AuxiliaryAttachments.R700action.getRenderablePart(), new Transition(renderContext -> {
                  GL11.glTranslatef(-0.59F, -0.43F, 0.5F);
                  GL11.glRotatef(90.0F, 0.0F, 0.0F, 1.0F);
               }, 250L, 50L), new Transition(renderContext -> {
                  GL11.glTranslatef(-0.59F, -0.43F, 0.5F);
