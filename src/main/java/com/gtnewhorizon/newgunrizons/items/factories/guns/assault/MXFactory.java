   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Assault rifle", "Damage: 8", "Caliber: 6.5x39mm NATO", "Magazines:", "30rnd 6.5x39mm NATO Magazine")
         )
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/mx"))
