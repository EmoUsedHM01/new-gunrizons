   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withCompatibleAttachment(AuxiliaryAttachments.P99Slide, true, model -> {
            if (JsonModel.is(model, "action/p99slide")) {
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/p99"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.P99Slide.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F)
               )
               ...
               .withFirstPersonCustomPositioningUnloading(
                  AuxiliaryAttachments.P99Slide.getRenderablePart(), new Transition(renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F), 250L, 1000L)
               )
               .withFirstPersonCustomPositioningReloading(
