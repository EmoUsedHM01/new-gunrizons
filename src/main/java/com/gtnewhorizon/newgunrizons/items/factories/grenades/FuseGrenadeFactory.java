      ...
      return new ItemGrenade.Builder()
         ...
         .withRenderer(
            new GrenadeRenderer.Builder()
               .withModel(new JsonModel("misc/m67frag"))
               ...
               .withFirstPersonCustomPositioningSafetyPinOff(Grenades.GrenadeSafetyPin.getRenderablePart(), new Transition(renderContext -> {
                  GL11.glScalef(0.2F, 0.2F, 0.2F);
               ...
               .withFirstPersonCustomPositioningThrowing(Grenades.GrenadeSafetyPin.getRenderablePart(), new Transition(renderContext -> {
                  GL11.glScalef(0.2F, 0.2F, 0.2F);
                  GL11.glRotatef(80.0F, 1.0F, 0.0F, 0.0F);
                  GL11.glRotatef(-90.0F, 0.0F, 1.0F, 0.0F);
                  GL11.glTranslatef(-3.9F, 1.4F, -2.4F);
