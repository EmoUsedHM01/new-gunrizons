   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: Designated Marksmen Rifle", "Damage: 8", "Caliber: 7.62x51mm NATO", "Magazines:", "10rnd 7.62x51mm NATO Magazine", "Fire Rate: Semi"
            )
         )
         .withCompatibleAttachment(Magazines.M110Mag, model -> {
            GL11.glTranslatef(-0.33F, 0.5F, -1.3F);
            GL11.glScaled(1.05, 1.2, 1.0);
         })
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/m110"))
