      ...
      return new ItemWeapon.Builder()
         ...
         .withCompatibleAttachment(AuxiliaryAttachments.AR15Iron, true, model -> {
            if (JsonModel.is(model, "sight/m4iron1")) {
               ...
               GL11.glScaled(0.0, 0.0, 0.0);
            } else if (JsonModel.is(model, "sight/ar15carryhandle")) {
               GL11.glTranslatef(-0.063F, -1.07F, -0.43F);
               GL11.glScaled(0.31, 0.45, 0.54);
            } else if (JsonModel.is(model, "sight/mp5iron")) {
               GL11.glTranslatef(0.215F, -1.54F, 1.2F);
               GL11.glScaled(0.0, 0.0, 0.0);
            }
