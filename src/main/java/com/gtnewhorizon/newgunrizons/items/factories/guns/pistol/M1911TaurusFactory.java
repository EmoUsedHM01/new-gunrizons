   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Pistol", "Damage: 5.5", "Caliber: .45 ACP", "Magazines:", "10rnd .45 ACP Magazine", "Fire Rate: Semi")
         )
         .withCompatibleAttachment(AuxiliaryAttachments.Taurus1911Slide, true, model -> {
            if (JsonModel.is(model, "action/taurus1911slide")) {
               GL11.glScaled(1.0, 1.0, 1.0);
            } else if (JsonModel.is(model, "sight/m1911rearsight")) {
               GL11.glTranslatef(-0.155F, -1.175F, -0.15F);
               GL11.glScaled(0.3, 0.3, 0.3);
            } else if (JsonModel.is(model, "sight/m1911frontsight")) {
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/taurus1911"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.Taurus1911Slide.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F)
               )
               ...
               .withFirstPersonCustomPositioningUnloading(Magazines.ColtM1911Mag, new Transition(renderContext -> {}, 250L, 1000L))
               ...
               .withFirstPersonCustomPositioningUnloading(
                  AuxiliaryAttachments.Taurus1911Slide.getRenderablePart(), new Transition(renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F), 250L, 1000L)
               )
               .withFirstPersonCustomPositioningReloading(
