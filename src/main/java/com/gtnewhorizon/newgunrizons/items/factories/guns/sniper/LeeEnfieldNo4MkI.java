      ...
      return new ItemWeapon.Builder()
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/leeenfieldno4"))
               ...
               .withFirstPersonCustomPositioningReloading(Magazines.LeeEnfieldMag, new Transition(renderContext -> {
               ...
               .withFirstPersonCustomPositioningUnloading(Magazines.LeeEnfieldMag, new Transition(renderContext -> {
                  GL11.glTranslatef(0.0F, 0.75F, -0.25F);
                  GL11.glRotatef(-20.0F, 1.0F, 0.0F, 0.0F);
               }, 250L, 50L), new Transition(renderContext -> {
                  GL11.glTranslatef(0.0F, 0.7F, 0.0F);
