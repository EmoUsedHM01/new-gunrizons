   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList("Type: Carbine", "Damage: 8", "Caliber: .308 Winchester", "Magazines:", "10rnd .308 Winchester Magazine", "Fire Rate: Auto")
         )
         .withCompatibleAttachment(Magazines.Mag308, model -> GL11.glScaled(1.0, 1.0, 1.0))
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/pofusa"))
