   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withCompatibleAttachment(AuxiliaryAttachments.P226Top, true, model -> {
            if (JsonModel.is(model, "action/p225top")) {
               GL11.glScaled(1.0, 1.0, 1.0);
            } else if (JsonModel.is(model, "sight/p226rearsight")) {
               GL11.glTranslatef(-0.155F, -1.175F, 0.03F);
               GL11.glScaled(0.3, 0.25, 0.25);
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/p220"))
               ...
               .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.P226Top.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F))
               .withFirstPersonPositioningCustomZoomingRecoiled(
                  AuxiliaryAttachments.P226Top.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F)
               )
               ...
               .withFirstPersonCustomPositioningUnloading(
                  AuxiliaryAttachments.P226Top.getRenderablePart(), new Transition(renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F), 250L, 1000L)
               )
               .withFirstPersonCustomPositioningReloading(
