   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: Pistol", "Damage: 6.5", "Caliber: .50 Action Express", "Magazines:", "7rnd .50 Action Express Magazine", "Fire Rate: Semi"
            )
         )
         ...
         .withCompatibleAttachment(Magazines.Deagle50Mag, model -> {
            ...
            GL11.glScaled(0.7, 1.0, 1.0);
         })
         .withTextureName("Deagle44")
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/deagle"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.Deagle44Top.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F)
               )
               ...
               .withFirstPersonCustomPositioningUnloading(Magazines.Deagle50Mag, new Transition(renderContext -> {}, 250L, 1000L))
               ...
               .withFirstPersonCustomPositioningUnloading(
                  AuxiliaryAttachments.Deagle44Top.getRenderablePart(), new Transition(renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F), 250L, 1000L)
               )
               .withFirstPersonCustomPositioningReloading(
