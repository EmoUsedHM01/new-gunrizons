...
public class MakarovPMFactory {
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(stack -> Arrays.asList("Type: Pistol", "Damage: 5", "Caliber: 9mm", "Magazines:", "10rnd 9mm Magazine", "Fire Rate: Semi"))
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/makarovpm"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.MakarovTop.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F)
               )
               ...
               .withFirstPersonCustomPositioningUnloading(Magazines.Magazine9mm, new Transition(renderContext -> {}, 250L, 1000L))
               ...
               .withFirstPersonCustomPositioningUnloading(
                  AuxiliaryAttachments.MakarovTop.getRenderablePart(), new Transition(renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F), 250L, 1000L)
               )
               .withFirstPersonCustomPositioningReloading(
