   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: General-Purpose Machine Gun", "Damage: 12", "Caliber: 7.62x51mm", "Magazines:", "100rnd 7.62x51mm Magazine", "Fire Rate: Auto"
            )
         )
         .withCompatibleAttachment(Magazines.Mk48Mag, model -> {})
         .withCompatibleAttachment(AuxiliaryAttachments.M249Action, true, model -> GL11.glScaled(1.0, 1.0, 1.0))
         .withCompatibleAttachment(AuxiliaryAttachments.M249Cover, true, model -> {
            if (JsonModel.is(model, "action/m249cover")) {
               GL11.glScaled(1.0, 1.0, 1.0);
            } else if (JsonModel.is(model, "sight/m249rearsight")) {
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/mk48mod1"))
               ...
               .withFirstPersonCustomPositioningUnloading(
                  AuxiliaryAttachments.M249Cover.getRenderablePart(), new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glScaled(1.0, 1.0, 1.0);
               ...
               .withFirstPersonCustomPositioningUnloading(
                  Attachments.ACOG.getRenderablePart(), new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -1.7F, -1.95F);
                     GL11.glRotatef(80.0F, 1.0F, 0.0F, 0.0F);
                  }, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -1.7F, -1.95F);
               ...
               .withFirstPersonCustomPositioningUnloading(
                  Attachments.Specter.getRenderablePart(), new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -2.5F, -1.95F);
                     GL11.glRotatef(80.0F, 1.0F, 0.0F, 0.0F);
                  }, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -2.5F, -1.95F);
               ...
               .withFirstPersonCustomPositioningUnloading(
                  Attachments.Reflex.getRenderablePart(), new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -1.6F, 1.3F);
                     GL11.glRotatef(80.0F, 1.0F, 0.0F, 0.0F);
                  }, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -1.6F, 1.3F);
               ...
               .withFirstPersonCustomPositioningUnloading(
                  Attachments.Kobra.getRenderablePart(), new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -1.6F, 1.3F);
                     GL11.glRotatef(80.0F, 1.0F, 0.0F, 0.0F);
                  }, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -1.6F, 1.3F);
               ...
               .withFirstPersonCustomPositioningUnloading(
                  Attachments.Holo2.getRenderablePart(), new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -1.6F, 1.3F);
                     GL11.glRotatef(80.0F, 1.0F, 0.0F, 0.0F);
                  }, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -1.6F, 1.3F);
               ...
               .withFirstPersonCustomPositioningUnloading(
                  Attachments.Holographic2.getRenderablePart(), new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -1.6F, 1.3F);
                     GL11.glRotatef(80.0F, 1.0F, 0.0F, 0.0F);
                  }, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -1.6F, 1.3F);
               ...
               .withFirstPersonCustomPositioningUnloading(
                  Attachments.MicroT1.getRenderablePart(), new Transition(renderContext -> {}, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -1.6F, 1.3F);
                     GL11.glRotatef(80.0F, 1.0F, 0.0F, 0.0F);
                  }, 250L, 1000L), new Transition(renderContext -> {
                     GL11.glTranslatef(0.0F, -1.6F, 1.3F);
