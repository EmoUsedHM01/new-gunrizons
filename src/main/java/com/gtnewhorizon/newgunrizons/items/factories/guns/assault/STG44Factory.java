   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: Assault Rifle", "Damage: 8.5", "Caliber: 7.92x33mm Kurz", "Magazines:", "30rnd 7.92x33mm Kurz Magazine", "Fire Rate: Auto"
            )
         )
         .withCompatibleAttachment(Magazines.STG44Mag, model -> GL11.glScaled(1.0, 1.0, 1.0))
         .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, model -> {
            if (JsonModel.is(model, "sight/g36ciron1")) {
               GL11.glTranslatef(-0.04F, -1.216F, -1.65F);
               GL11.glScaled(0.4, 0.3, 0.7);
               GL11.glRotatef(180.0F, 0.0F, 0.0F, 1.0F);
            } else if (JsonModel.is(model, "sight/g36ciron2")) {
               GL11.glTranslatef(-0.18F, -1.82F, -7.35F);
               GL11.glScaled(0.4, 0.53, 0.8);
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/stg44"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.STG44Action.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 1.0F)
               )
