   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withCompatibleAttachment(AuxiliaryAttachments.M1911Top, true, model -> {
            if (JsonModel.is(model, "action/m1911top")) {
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/m1911"))
               ...
               .withFirstPersonPositioningCustomRecoiled(
                  AuxiliaryAttachments.M1911Top.getRenderablePart(), renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F)
               )
               ...
               .withFirstPersonCustomPositioningUnloading(
                  AuxiliaryAttachments.M1911Top.getRenderablePart(), new Transition(renderContext -> GL11.glTranslatef(0.0F, 0.0F, 0.5F), 250L, 1000L)
               )
               .withFirstPersonCustomPositioningReloading(
