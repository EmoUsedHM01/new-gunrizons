   ...
   public Item createGun() {
      return new ItemWeapon.Builder()
         ...
         .withInformationProvider(
            stack -> Arrays.asList(
               "Type: Personal Defense Weapon", "Damage: 5", "Caliber: 9mm", "Magazines:", "15rnd 9mm Magazine", "50rnd 9mm Magazine", "Fire Rate: Auto"
            )
         )
         .withCompatibleAttachment(Magazines.M9BerettaMag, model -> {
            GL11.glTranslatef(-0.01F, 0.3F, -1.08F);
            GL11.glScaled(0.95, 1.2, 0.8);
         })
         ...
         .withRenderer(
            new WeaponRenderer.Builder()
               .withModel(new JsonModel("weapon/udp9"))
