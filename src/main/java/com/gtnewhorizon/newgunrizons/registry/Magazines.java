...
public class Magazines {
   ...
   public static void init() {
      PythonClip = new ItemMagazine.Builder()
         .withAmmo(6)
      ...
      STG44Mag = new ItemMagazine.Builder()
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      SVT40mag = new ItemMagazine.Builder()
         .withAmmo(10)
      ...
      LeeEnfieldMag = new ItemMagazine.Builder()
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      Saiga12mag = new ItemMagazine.Builder()
         .withAmmo(5)
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      VEPR12Mag = new ItemMagazine.Builder()
         .withAmmo(8)
         .withCompatibleBullet(Bullets.ShotgunShell)
         .withName("VEPR12Mag")
         .withCreativeTab(NewGunrizonsMod.AmmoTab)
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      Saiga410Mag = new ItemMagazine.Builder()
         .withAmmo(7)
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      Type100Mag = new ItemMagazine.Builder()
         .withAmmo(30)
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      MP18mag = new ItemMagazine.Builder()
         .withAmmo(32)
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      M1A1mag = new ItemMagazine.Builder()
         .withAmmo(30)
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      PPSH41DrumMag = new ItemMagazine.Builder()
         .withAmmo(71)
         .withCompatibleBullet(Bullets.Bullet762x25)
         .withName("PPSH41Mag")
         .withCreativeTab(NewGunrizonsMod.AmmoTab)
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      Mag75rnd762x39 = new ItemMagazine.Builder()
         .withAmmo(75)
         .withCompatibleBullet(Bullets.Bullet762x39)
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      M8A7Mag = new ItemMagazine.Builder()
         .withAmmo(32)
      ...
      PMAG762x39 = new ItemMagazine.Builder()
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      AK15Mag = new ItemMagazine.Builder()
         .withAmmo(30)
         .withCompatibleBullet(Bullets.Bullet762x39)
         .withName("AK15Mag")
         .withCreativeTab(NewGunrizonsMod.AmmoTab)
      ...
      NATOMag1 = new ItemMagazine.Builder()
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      MPXmag = new ItemMagazine.Builder()
         .withAmmo(30)
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      Mag308 = new ItemMagazine.Builder()
         .withAmmo(10)
      ...
      NATO20rnd = new ItemMagazine.Builder()
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      M16A1Mag = new ItemMagazine.Builder()
         .withAmmo(20)
         .withCompatibleBullet(Bullets.Bullet556x45)
         .withName("M16A1Mag")
         .withCreativeTab(NewGunrizonsMod.AmmoTab)
      ...
      M110Mag = new ItemMagazine.Builder()
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      HK417Mag = new ItemMagazine.Builder()
         .withAmmo(10)
         .withCompatibleBullet(Bullets.Bullet762x51)
         .withName("HK417Mag")
         .withCreativeTab(NewGunrizonsMod.AmmoTab)
      ...
      Glock21Mag = new ItemMagazine.Builder()
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      LugerP08Mag = new ItemMagazine.Builder()
         .withAmmo(8)
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      Tec9Mag = new ItemMagazine.Builder()
         .withAmmo(20)
         .withCompatibleBullet(Bullets.Bullet9mm)
         .withName("Tec9Mag")
         .withCreativeTab(NewGunrizonsMod.AmmoTab)
      ...
      MP40Mag = new ItemMagazine.Builder()
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      M3A1Mag = new ItemMagazine.Builder()
         .withAmmo(31)
         .withCompatibleBullet(Bullets.Bullet45ACP)
         .withName("M3A1Mag")
         .withCreativeTab(NewGunrizonsMod.AmmoTab)
      ...
      MP5KMag = new ItemMagazine.Builder()
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      Deagle50Mag = new ItemMagazine.Builder()
         .withAmmo(7)
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      VSSVintorezMag = new ItemMagazine.Builder()
         .withAmmo(10)
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      ASValMag = new ItemMagazine.Builder()
         .withAmmo(20)
         .withCompatibleBullet(Bullets.Bullet9x39mm)
         .withName("ASValMag")
         .withCreativeTab(NewGunrizonsMod.AmmoTab)
      ...
      M1CarbineMag = new ItemMagazine.Builder()
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      M2CarbineMag = new ItemMagazine.Builder()
         .withAmmo(30)
         .withCompatibleBullet(Bullets.Carbine30)
      ...
      L115Mag = new ItemMagazine.Builder()
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      SV98Mag = new ItemMagazine.Builder()
         .withAmmo(10)
         .withCompatibleBullet(Bullets.Bullet762x54)
         .withName("SV98Mag")
         .withCreativeTab(NewGunrizonsMod.AmmoTab)
      ...
      M249Mag = new ItemMagazine.Builder()
         ...
         .withTextureName("Dummy.png")
         .build(ItemMagazine.class);
      Mk48Mag = new ItemMagazine.Builder()
         .withAmmo(100)
         .withCompatibleBullet(Bullets.Bullet762x51)
         .withName("Mk48Mag")
         .withCreativeTab(NewGunrizonsMod.AmmoTab)
