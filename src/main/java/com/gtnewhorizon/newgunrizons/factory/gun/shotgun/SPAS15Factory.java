package com.gtnewhorizon.newgunrizons.factory.gun.shotgun;
...
import com.gtnewhorizon.newgunrizons.factory.gun.GunFactory;
import com.gtnewhorizon.newgunrizons.model.weapon.SPAS15;
...
public class SPAS15Factory implements GunFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        return (new Weapon.Builder()).withModId("newgunrizons")
            .withName("SPAS-15")
            .withAmmoCapacity(8)
            .withFireRate(0.3F)
            .withRecoil(9.0F)
